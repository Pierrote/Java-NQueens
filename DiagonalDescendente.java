...
import java.lang.*;
 ...
 /**
 * Classe DiagonalDescendente que implementa a interface {@link Fila}
 */ 
...
/**
 * Construtor da Classe DiagonalDescendente
 ...
 */ 
    ...
    public DiagonalDescendente(int linha, int coluna, int cmp, String str){
        line = linha;
        co = coluna;
        cm = cmp;
        s = str;
 ...
 /**
 * Método utilizado para retornar o comprimento da Diagonal Descendente
 * @return Comprimento da Diagonal Descendente
 */ 
 ...
 */ 
    ...
    public Peca peca(int pos) throws IndexOutOfBoundsException {
        ...
        DiagonalDescendente dd = tab.diagonalDescendente(line, co);
        int a = dd.comprimento();
        int p;
        Peca q = null;
        int count = 0;
        int l = line;
